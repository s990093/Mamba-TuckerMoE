...
Usage (from repo root):
  python inference/bench_optimizations_ab.py
  python inference/bench_optimizations_ab.py --decode-tokens 256 --trials 5 --dtype bf16
  python inference/bench_optimizations_ab.py --chart   # save PNG bar chart
"""
...
def main() -> None:
    ...
    p.add_argument(
        ...
        default=None,
        metavar="PATH",
        help="Save bar chart PNG (default: bench_optimizations_ab.png in inference/)",
    )
    p.add_argument(
        "--json",
        nargs="?",
        ...
        default=None,
        metavar="PATH",
        help="Save JSON results (default: bench_optimizations_ab.json in inference/)",
    )
    args = p.parse_args()
    ...
    if args.json is not None:
        json_path = (
            os.path.join(_INF_DIR, "bench_optimizations_ab.json")
    ...
    if args.chart is not None:
        chart_path = (
            os.path.join(_INF_DIR, "bench_optimizations_ab.png")
